### Getting the output side by side and download the output in txt, and csv files 

### added dropdown for document type

## added the user input as url or local file of image type
...
document_type = st.selectbox("Select Document Type", ["Aadhaar Card", "PAN Card", "Ration Card", "Passport", "Driving Licence", "Voter id", "Bank Cheque", "Electricity bill", "Other"])

# Language selection
language = st.selectbox("Select language", ["English", "Hindi", "Telugu", "Tamil" , "Spanish", "French", "German"])

input_type = st.radio("Choose Input Type:", ("Local File", "URL"))
